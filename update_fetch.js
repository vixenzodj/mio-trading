...
const pattern = /    def fetch_data_smart\(ticker, timeframe, start_date, end_date\):[\s\S]*?        return df/g;

const newFunc = `    def fetch_data_smart(ticker, timeframe, start_date, end_date):
        import io
        import requests
